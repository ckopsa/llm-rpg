...
const R = [
  ...
  // ── objectives: the standing "what do I do now?" ─────────────────────────
  // Shortest sentences in the game — a stuck five-year-old is listening to
  // these, often more than once, so every one is an instruction with a verb.
  ["Take care of two things on the farm. Then pray at the stone.", "Look after two things. Then pray at the stone."],
  ["Take care of two more things on the farm.", "Look after two more things."],
  ["Pray at the stone.", "Pray at the stone."],
  ["Walk down to the road and go east.", "Go down to the road. Then go east."],
  ["Go to the dust in the yard.", "Go to the dust in your yard."],
  ["Go and talk to your wife.", "Go and talk to your wife."],
  ["Walk east across the ashes.", "Walk east across the ashes."],
  ["Sit down in the ashes.", "Sit down in the ashes."],
  ["Answer your three friends. Say what is true.", "Talk to your three friends. Tell them the truth."],
  ["Go and talk to the young man waiting behind them.", "Go and talk to the young man."],
  ["Walk to the stone in the storm.", "Walk to the stone in the storm."],
  ["Pray for each of your three friends.", "Pray for all three of your friends."],
  ["Pray for your other friends too.", "Pray for your other friends too."],
  ["Walk down into the yard.", "Go down into the yard."],
  ["Go and stand in the gate.", "Go and stand in the gate."],
];
